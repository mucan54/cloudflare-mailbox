        ...
        return $schema->components([
            ...
            TextInput::make('api_token')
                ...
                ->helperText(new HtmlString(
                    ...
                    .'<li>Account · <b>Workers Scripts</b> · Edit <span style="opacity:.7">(Worker deploy için)</span></li>'
                    .'<li>User · <b>User Details</b> · Read <span style="opacity:.7">(wrangler gerektiriyor)</span></li>'
                    .'</ul>'
